...
var environment_service_1 = __importDefault(require("../services/environment.service"));
    ...
    EnvironmentController.getInfo = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, getInfoEnvironment_joiSchema_1.getInfoEnvironmentParamSchema.validateAsync(req.query)];
                    case 1:
                        date = _c.sent();
                        _b = (_a = res.status(200)).json;
                        return [4 /*yield*/, environment_service_1.default.getInfo(date)];
                    case 2:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
